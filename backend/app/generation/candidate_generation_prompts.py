...
class CandidatePromptBuilder:
    """Builds the LLM prompt used to generate a fictional candidate CV."""

    TEMPLATE = """
Generate one realistic but completely fictional professional CV candidate.
...
MANDATORY RESUME CONTENT: The generated candidate MUST contain
    ...
    1. A realistic fictional full name.
...
WORK EXPERIENCE RULES:
    ...
    6. Employer names must be fictional.
...
SKILLS RULES:
    ...
    The following skills MUST explicitly appear:{skills}, Generate between 5 and 12 total skills.

EDUCATION RULES:

    The candidate MUST have studied at exactly: {university}. Generate a degree appropriate to the candidate's career.
...
IMPORTANT SAFETY / SYNTHETIC DATA RULES:
    ...
    The candidate must be fictional. Do not generate or imitate an identifiable real person.
    Employer names must be fictional. Do not use real personal contact information.
